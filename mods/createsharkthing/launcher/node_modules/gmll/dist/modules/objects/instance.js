...
class Instance {
    ...
    constructor(opt = {}) {
        this.id = opt.id || (0, crypto_1.randomUUID)();
    ...
    getJarModPriority = modsHandler.getJarModPriority;
    /**Install forge in this instance. */
    installForge = modsHandler.installForge;
    /**
     ...
     */
    getResourcePacks = metaHandler.getResourcePacks;
    /**
     ...
     */
    getWorlds = metaHandler.getWorlds;
    /**
    ...
    getDir() {
        return new files_js_1.Dir((0, config_js_1.resolvePath)(this.path));
    }
    /**Gets a list of profiles that where saved previously */
    static getProfiles() {
        const profiles = new Map();
        (0, config_js_1.getMeta)().profiles.ls().forEach(e => {
            if (e instanceof files_js_1.File && e.getName().endsWith(".json")) {
    ...
    static get(profileID) {
        if (!profileID.endsWith(".json"))
            profileID += ".json";
        const _file = (0, config_js_1.getMeta)().profiles.getFile((0, util_js_1.fsSanitizer)(profileID));
     ...
     */
    save() {
        (0, config_js_1.getMeta)().profiles.getFile((0, util_js_1.fsSanitizer)(this.id || this.name + ".json")).write(this);
        return this;
    }
    /**
