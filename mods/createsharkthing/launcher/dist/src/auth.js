...
exports.getBrowser = exports.getLink = exports.fastAuth = exports.authenticate = void 0;
...
function fastAuthSuccess(input) {
    let object = input;
...
function getBrowser() {
    let browser = (0, util_1.get)();
    if (!browser)
        return false;
    return (0, path_1.join)(browser.browser, browser.app);
}
